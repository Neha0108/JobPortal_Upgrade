...
/**
 * Single place every controller's exceptions funnel through, so every error
 * response - regardless of which layer threw - comes back in the same
 * ApiResponse envelope the success responses use.
 */
